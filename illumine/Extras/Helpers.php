...
if(!function_exists('illumine')){
     ...
     * @return mixed|IlluminePlugin
     */
    function illumine($make = null, $parameters = [])
    {
        if (is_null($make)) return IlluminePlugin::getInstance();

        return IlluminePlugin::getInstance()->make($make, $parameters);
    }
}
...
if (!function_exists('route_url')) {
     ...
     * @return string
     */
    function route_url($name, $parameters = array(), $absolute = true, $route = null){
        $router = illumine()->getRouter();
        $router->getRoutes()->refreshNameLookups();
        $urlGenerator = illumine()->getUrlGenerator();
